...
class Pins(object):
    ...
    def print_adc(self, adc_num):
        ...
        if adc_pins:
            ...
            self.adc_table_size[adc_num] = 0
            # If all adcx pins are hidden, we still need to print an empty table to avoid linker errors.
            print("")
            print("const pin_obj_t * const pin_adc{:d}[{:d}] = {{".format(adc_num, 0))
            print("    /* No pins available for this table */")
            print("}; ")
